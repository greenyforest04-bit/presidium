...
fn domain_value_objects_are_self_contained() {
    use presidium_core::domain::value_objects::{UserId, DeviceId, SessionId, ChatId, MessageContent, ChatType};
...
fn domain_entities_are_self_contained() {
    use presidium_core::domain::entities::{User, Device, Message, Chat};
    use presidium_core::domain::value_objects::{UserId, DeviceId, ChatId, ChatType};
...
fn domain_events_are_self_contained() {
    use presidium_core::domain::events::{
        DomainEvent, UserRegistered, SessionEstablished,
    };
    use presidium_core::domain::value_objects::{UserId, DeviceId, SessionId};
...
fn domain_aggregates_are_self_contained() {
    ...
    use presidium_core::domain::value_objects::{UserId, ChatType};
    ...
    conv.send_message(alice, "Hello!".to_string()).expect("send message");
...
fn application_use_cases_exist() {
    use presidium_core::application::use_cases::send_message::{
        SendMessageInput, SendMessageOutput, SendMessageError,
    };
